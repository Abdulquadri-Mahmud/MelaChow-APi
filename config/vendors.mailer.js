...
/**
 * Sends styled GrubDash Vendor email for login, password reset, or resend OTP
...
export const sendVendorEmail = async (vendor, otp, type) => {
  ...
  switch (type) {
    case "login":
      subject = "Your GrubDash Vendor Login OTP";
      headerText = "Login Verification OTP";
      subHeaderText = "Manage your store 🍴";
      bodyText = `
        <p>Use the OTP below to log in to your <strong>GrubDash Vendor</strong> account.<br/>
        This code expires in <strong>10 minutes</strong>:</p>
      `;
      break;

    case "reset":
      subject = "Reset your GrubDash Vendor password";
      headerText = "Password Reset OTP";
      subHeaderText = "Reset your password 🔐";
      bodyText = `
        <p>We received a request to reset your <strong>GrubDash Vendor</strong> password.<br/>
        Use the OTP below to continue. It expires in <strong>10 minutes</strong>:</p>
      `;
      break;

    case "resend":
      subject = "Your new GrubDash Vendor OTP";
      headerText = "New Verification OTP";
      subHeaderText = "Your new login code 🔁";
      bodyText = `
        <p>Here’s your new OTP to log in to your <strong>GrubDash Vendor</strong> account.<br/>
    ...
    <div style="font-family: 'Segoe UI', sans-serif; background-color: #f9f9f9; padding: 30px;">
      <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        <div style="background-color: #FF6600; padding: 20px; text-align: center;">
          <h1 style="color: white; margin: 0;">GrubDash Vendor</h1>
        ...
        <div style="background-color: #fafafa; text-align: center; padding: 15px; font-size: 12px; color: #777;">
          <p>© ${year} GrubDash. All rights reserved.</p>
        </div>
      </div>
    </div>
  `;
